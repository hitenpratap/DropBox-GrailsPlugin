...
class AccessTokenService {
    ...
    String app_key = ConfigurationHolder.config.grails.plugins.dropBox.app_key
    String app_secret = ConfigurationHolder.config.grails.plugins.dropBox.app_secret
